...
export default function AdminPaperQuestionsPage() {
  ...
  async function fetchPaper() {
    ...
    console.log("json.data.questions =", json.data?.questions);


    // ✅ DIRECT MATCH WITH YOUR DB
    setPaper({
      ...json.data,
    ...
    <div className="min-h-screen bg-[#0B0F1A] text-slate-200">
      ...
      <header className="border-b border-white/10 bg-[#0F1629]">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <h1 className="text-xl font-bold text-white">{paper.name}</h1>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        {paper.questions.length === 0 && (
          <div className="bg-[#11172C] border border-white/10 rounded-xl p-10 text-center text-slate-500">
          ...
          >
            <div className="flex justify-between">
              <h3 className="font-semibold">
                Q{q.q_no} • {q.marks} marks • {q.structure}/{q.nature}
              </h3>
            ...
            {/* SINGLE QUESTION */}
            {q.structure === "single" && q.question_md && (
...
/* =====================================================
   QUESTION EDITOR
   (UNCHANGED — YOUR VERSION IS CORRECT)
===================================================== */
// ⬇️ keep exactly as you had it
